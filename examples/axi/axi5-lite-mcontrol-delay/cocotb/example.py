...
async def test(dut):
    """
    Example AXI5-Lite Interface with Manager control delays
    ...
    avl.Factory.set_variable("*.agent.mwdrv.control_rate_limit", lambda: 0.5)
    avl.Factory.set_variable("*.agent.mrdrv.control_rate_limit", lambda: 0.1)
